package com.p.java.playground.api.base.response;
...
public class ResponseMapper {
   ...
   */
  public static <T> ResponseEntity<StandardResponse<T>> createSuccessResponse(
   ...
   */
  public static <T> ResponseEntity<StandardResponse<T>> createErrorResponse(
      String message, HttpStatus status, Exception exception) {
   ...
   */
  private static <T> ResponseEntity<StandardResponse<T>> buildResponse(
      String status, String message, T data, HttpStatus httpStatus) {
    StandardResponse<T> response =
        StandardResponse.<T>builder()
            .status(status)
            .message(message)
            .data(data)
